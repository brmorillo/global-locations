...
try {
  ...
  console.log('getAllCountriesAndData():', `${allCountries.length} countries found`);
  
  // Get all countries without states
  const countriesNoStates = globalLocations.Countries.getAllCountries();
  console.log('getAllCountries():', `${countriesNoStates.length} countries found (without states)`);
  ...
  console.log('getCountryBy({property: "id", value: "BR", selectStates: false}):', brazil?.name);
  ...
  console.log('getCountryBy({property: "id", value: "BR", selectStates: true}):', 
  ...
  console.log('getStatesByCountryId("BR"):', `${brazilStates?.length} states found`);
  ...
  console.log('getStateByParams({countryId: "BR", params: {property: "acronym", value: "SP"}}):', 
    saoPaulo?.name);
  ...
  console.log('isStateInCountry({countryId: "BR", stateId: "35"}):', stateInCountry);
  
  // Get all cities in a country
  const brazilCities = globalLocations.Countries.getAllCities({ countryId: 'BR' });
  console.log('getAllCities({countryId: "BR"}):', `${brazilCities.length} cities found`);
  ...
  console.log('getCitiesByStateId({countryId: "BR", stateId: "35"}):', 
  ...
  console.log('getCitiesByParams({countryId: "BR", stateId: "35", params: {property: "name", value: "São Paulo"}}):', 
    saoPauloCity);
} catch (error) {
...
try {
  const allCountries = globalLocations.GlobalLocations.Countries.getAllCountries();
  console.log('GlobalLocations.Countries.getAllCountries():', 
  ...
  console.log('GlobalLocations.Countries.getCountryBy({property: "id", value: "BR", selectStates: false}):', 
    brazil?.name);
} catch (error) {
